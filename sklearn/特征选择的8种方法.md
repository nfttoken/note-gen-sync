...
1. 评分函数可选的方法有：selector = SelectKBest(score_func=,k=5)
2. For regression: r_regression, f_regression, mutual_info_regression(适用大量样本)
3. For classification: chi2, f_classif, mutual_info_classif(适用大量样本)
